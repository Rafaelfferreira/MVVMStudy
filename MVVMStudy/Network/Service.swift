...
protocol MovieService {
    func fetchMovies(from endpoint: MovieListEndpoints, completion: @escaping (MoviesList, MovieDBError) -> ())
    func fetchMovie(id: Int, completion: @escaping (Movie, MovieDBError) -> ())
    func searchMovie(query: String, completion: @escaping (MoviesList, MovieDBError) -> ())
}
